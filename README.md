...
Включает лабораторные работы по курсу "Операционные системы", которые содержат как базовые концепции операционных систем Linux (в частности, Ubuntu и Alt Linux), так и темы, такие как виртуализация, управление пользователями, правами доступа и процессами. Каждая работа содержит отчеты с изученными материалами.
